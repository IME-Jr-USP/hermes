...
function App() {
    ...
    useEffect(() => {
        ...
        const labelInterval = window.setInterval(() => {
            setThinkingLabelIndex((currentIndex) =>
                getRandomThinkingLabelIndex(currentIndex),
            );
    ...
    async function handleSubmit(event: SyntheticEvent<HTMLFormElement>) {
        ...
        if (isFirstMessage) {
            pendingComposerRectRef.current =
        ...
        <>
            ...
            >
                <section
                    ...
                    aria-describedby={
                        hasConversation ? undefined : "welcome-message"
                    }
                >
                    {shouldShowWelcome && (
                        <div
                        ...
                        >
                            ...
                            <div className="welcome-copy">
                                ...
                                >
                                    Qual matéria da USP vamos descobrir hoje?
                                </p>
                            </div>
                        </div>
                    )}
                    ...
                    {hasConversation && (
                        <div
                            ...
                            ref={transcriptRef}
                            aria-label="Conversa com Hermes"
                        >
                            ...
                            <div className="message-list">
                                ...
                                {isAssistantThinking && (
                                    <article
                                        ...
                                        aria-label="Hermes está pensando"
                                    >
                                        <div
                    ...
                    >
                        ...
                        <button
                            type="submit"
                            disabled={!hasMessage || isAssistantBusy}
                        >
